...
export default function DetailData({ reserveData, reserveConfigData, price }) {
  const data = getData(reserveData, reserveConfigData);
  const {
    tokenInfo,
    ltv,
    liquidationThreshold,
