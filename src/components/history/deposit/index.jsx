...
function getColumns(prices, t) {
  return [{
    title: t('history_deposit_table_asset'),
    dataIndex: 'symbol',
    key: 'symbol',
    className: 'symbol',
    render: (text, row) => (
    ...
    title: t('history_deposit_table_amount'),
    dataIndex: 'amount',
    key: 'amount',
    className: 'amount',
    render: (text, row) => (
    ...
    title: t('history_deposit_table_datetime'),
    dataIndex: 'timestamp',
    key: 'timestamp',
    className: 'timestamp',
    ...
    title: t('history_deposit_table_hash'),
...
function DepositHistory() {
  ...
  return (
    <SitePage
      ...
      header={(
        <>
          <a className="active"><FormattedMessage id="history_header_deposit" /></a>
